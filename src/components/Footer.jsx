      ...
      <div className="container">
        <div className="footer__grid">
          <div>
            ...
            <div className="footer__social" aria-label={t('footer.followOnSocial')}>
              <a
                href="https://www.facebook.com/cepumbums/?locale=lv_LV"
                className="footer__social-link"
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('footer.followOnFacebook')}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('footer.followOnInstagram')}
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('footer.followOnTikTok')}
              >
                <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            <h2 className="footer__heading">{t('footer.companyHeading')}</h2>
          ...
          <div>
            <h2 className="footer__heading">{t('footer.contactHeading')}</h2>
            <ul className="footer__links">
              <li>
